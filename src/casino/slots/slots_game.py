...
class Slots:
    ...
    def printScore(self):
        ...
        if (Slots.firstWheel == "CHERRY") and (Slots.secondWheel != "CHERRY"):
            ...
            (Slots.firstWheel == "CHERRY")
            and (Slots.secondWheel == "CHERRY")
            and (Slots.thirdWheel != "CHERRY")
        ):
            win = 5
        elif (
            (Slots.firstWheel == "CHERRY")
            ...
            (Slots.firstWheel == "ORANGE")
            and (Slots.secondWheel == "ORANGE")
            and ((Slots.thirdWheel == "ORANGE") or (Slots.thirdWheel == "BAR"))
        ):
            win = 10
        elif (
            (Slots.firstWheel == "PLUM")
            and (Slots.secondWheel == "PLUM")
            and ((Slots.thirdWheel == "PLUM") or (Slots.thirdWheel == "BAR"))
        ):
            win = 14
        elif (
            (Slots.firstWheel == "BELL")
            and (Slots.secondWheel == "BELL")
            and ((Slots.thirdWheel == "BELL") or (Slots.thirdWheel == "BAR"))
        ):
            win = 20
        elif (
            (Slots.firstWheel == "BAR")
            and (Slots.secondWheel == "BAR")
            and (Slots.thirdWheel == "BAR")
        ):
            win = 250
        else:
            win = 0
